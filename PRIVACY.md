...
- Contains **only** publicly available data from authoritative UK government sources

## Data Sources

All data in this MCP is sourced from publicly available UK government
publications by NCSC and NHS Digital, published under the Open Government
Licence v3.0. See `sources.yml` for the full list of data origins and their
licenses.
